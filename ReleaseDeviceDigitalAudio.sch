...
U 1 1 5F085A19
P 11150 7100
F 0 "J6" H 11200 7617 50  0000 C CNN
...
U 1 1 66962862
P 12200 1850
F 0 "J2" H 12182 2175 50  0000 C CNN
...
U 1 1 63313029
P 12800 6400
F 0 "#PWR08" H 12800 6250 50  0001 C CNN
...
U 1 1 6188FA04
P 11450 9150
F 0 "J9" H 11558 9431 50  0000 C CNN
...
U 1 1 6066C958
P 11400 2250
F 0 "J3" H 11382 2575 50  0000 C CNN
...
U 1 1 6123782D
P 12200 2650
F 0 "J4" H 12182 2975 50  0000 C CNN
...
F2 "GPIO9" O R 5550 4350 50 
F3 "GPIO10" I R 5550 1900 50 
F4 "I2C0" B L 3950 2050 50 
F5 "I2C1" B R 5550 1750 50 
F6 "RUN" I R 5550 7050 50 
F7 "I2S_Master" B R 5550 1600 50 
F8 "USB" B L 3950 2350 50 
F9 "UART1" B R 5550 6900 50 
F10 "UART0" B R 5550 4200 50 
$EndSheet
...
$Sheet
S 7200 6700 1600 2250
U 60F18E7A
F0 "ControllerUIBoard" 50
F1 "ControllerUIBoard.sch" 50
F2 "RPI_RUN_3.3V" O L 7200 7050 50 
F3 "IGNITION_SENSE" I R 8800 7050 50 
F4 "5V_EN_OUT" O R 8800 7200 50 
F5 "3V3_UART" B L 7200 6900 50 
$EndSheet
$Sheet
S 1000 8300 1600 2250
U 60F87146
F0 "7SegmentDriver" 50
F1 "7SegmentDriver.sch" 50
F2 "DigitCathodes" O R 2600 8550 50 
F3 "DecoderData" I L 1000 8550 50 
F4 "SegmentAnodes" O R 2600 8700 50 
F5 "SegmentDriverData" I L 1000 8700 50 
F6 "BrightnessRegulation" I L 1000 8950 50 
$EndSheet
...
U 1 1 5F0813F7
P 14500 7200
F 0 "J7" H 14550 8117 50  0000 C CNN
...
U 1 1 6127A338
P 14100 5950
F 0 "#PWR07" H 14100 5800 50  0001 C CNN
...
U 1 1 60E90993
P 13950 9200
F 0 "#PWR010" H 13950 8950 50  0001 C CNN
...
U 1 1 60E90CD2
P 11950 9450
F 0 "#PWR011" H 11950 9200 50  0001 C CNN
F 1 "GND" H 11955 9277 50  0000 C CNN
...
Alles bzgl Levelshifter checken\nCM3 durch CM4 ersetzen\nStromaufnahme CM4 @ 5V?\n3,3 und 1,8V Regler entfallen, da CM4 entsprechende Ausgänge hat\nChecken ob die bzgl. Ripple in Ordnung sind\nRTC alternative da aktuelle sehr teuer
Wire Bus Line
	5550 4200 7200 4200
$Comp
L power:GND #PWR?
